...
**Observations**:
Hypothesis 1 was not correct. I would guess that most diamond cutters aim for an ideal cut, which is why there are so many in that category. 
### Hypothesis 2
...
**Observations**:
- The hypotheis is not correct. There are highly varying sizes of diamond in each cut, and therefore highly varying prices. Also, a very large diamond in a poor cut can be recut to a smaller diamond in an ideal cut
...
**Observations**:
SOmewhat matches the hypothesis, but not conclusively 
